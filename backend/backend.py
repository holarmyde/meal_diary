...
mysql.init_app(app)
api_token = "j1KHV0ZxnLM43gLiaAVqNY1OjgZVOk"
...
#    print data['name']
    ...
    query = "https://api.clarifai.com/v1/tag/?url="+url+"&access_token="+api_token
    print query
...
def upload():
    ...
    fh.close()
    #fh_new = open(os.path.join(photo_path , filename_new) , "wb")
    #fh_new.write(base64_string)
    #fh_new.close()
    data={}
    data['image']= file_path
    param = urlencode(data)  
    flask.redirect(flask.url_for('get') , param, code=307)
